...
//set ambulance no auth
$config['auth_override_class_method']['history']['*']   = 'none';
$config['auth_override_class_method']['login']['*'] 	= 'none';
$config['auth_override_class_method']['mitra']['*'] 	= 'none';
$config['auth_override_class_method']['transaksi']['*'] = 'none';

//set on APP folder not in ambulance, dashboard and demo
$config['auth_override_class_method']['fasilitasrawatinap']['*'] = 'none';
$config['auth_override_class_method']['appointment']['*'] 		 = 'none';
$config['auth_override_class_method']['bedrawatinap']['*'] 		 = 'none';
$config['auth_override_class_method']['bpjs']['*'] 				 = 'none';
$config['auth_override_class_method']['dokterbyunit']['*'] 		 = 'none';
$config['auth_override_class_method']['history']['*'] 			 = 'none';
$config['auth_override_class_method']['jadwaldokter']['*'] 		 = 'none';
$config['auth_override_class_method']['login']['*'] 			 = 'none';
$config['auth_override_class_method']['message']['*'] 			 = 'none';
$config['auth_override_class_method']['news']['*'] 			 	 = 'none';
$config['auth_override_class_method']['notifantrian']['*'] 		 = 'none';
$config['auth_override_class_method']['pengguna']['*'] 			 = 'none';
$config['auth_override_class_method']['searchnoantrian']['*'] 	 = 'none';
$config['auth_override_class_method']['searchpasienlama']['*'] 	 = 'none';
$config['auth_override_class_method']['slideshow']['*'] 		 = 'none';
$config['auth_override_class_method']['smsmoo']['*']		 	 = 'none';
$config['auth_override_class_method']['unit']['*'] 				 = 'none';
$config['auth_override_class_method']['validation']['*'] 		 = 'none';
$config['auth_override_class_method']['news_parkir']['*'] 		 = 'none';


//set app notifikasi jadwal checkup tanpa auth
$config['auth_override_class_method']['notifikasi']['*'] 		 = 'none';
...
|
*/
$config['rest_valid_logins'] = ['caturindoapi' => 'caturindo123'];
