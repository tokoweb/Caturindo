  ...
  <template>
    ...
    <div v-if="lokasi_meeting == 'null'">
      ...
      <div class="col-md-12" style="padding: 20px">
        ...
        <!-- <center>
          <div class="panel col-md-3 col-md-offset-4">
            ...
            <div class="panel-heading bg-primary">
              ...
              <div class="panel-body">
                <div class="row">
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                      <button class="btn btn-primary" v-on:click="diLuarRuangan()">Outside the Office</button>
                    </div>
                  </div>
                </div>
              </div>
    ...
    <div v-else-if="lokasi_meeting === 'didalam'">
      ...
      <?php $this->load->view('user/sub_meeting/ruangan')?>

    </div>

    <div v-else-if="lokasi_meeting === 'diluar'">
      
      <?php $this->load->view('user/sub_meeting/transport')?>
