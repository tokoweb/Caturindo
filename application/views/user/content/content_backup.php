      ...
      <div class="panel">
        <div class="panel-body">
            <div class="col-md-6 col-sm-12">
                <h3 class="animated fadeInLeft">Manager</h3>
                <p class="animated fadeInDown"><span class="fa  fa-map-marker"></span> <?=$kota?>,Indonesia</p>
            ...
            <div class="col-md-6 col-sm-12">
                <div class="col-md-6 col-sm-6 text-right" style="padding-left:10px;">
                  <h3 style="color:#DDDDDE;"><span class="fa  fa-map-marker"></span> <?=$kota?></h3>
                  ...
                  <div class="col-md-12 padding-0">
                    <div class="panel box-v2">
                        <div class="panel-heading padding-0">
                          <img src="<?=base_url()?>assets/template/miminium/asset/img/bg2.jpg" class="box-v2-cover img-responsive"/>
                          <div class="box-v2-detail">
                            <img src="<?=base_url()?>assets/template/miminium/asset/img/avatar.jpg" class="img-responsive"/>
